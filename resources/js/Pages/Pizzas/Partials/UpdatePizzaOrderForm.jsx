  ...
  return (
    <section className={className}>
      <header>
        ...
        <p className="mt-1 text-sm text-grat-600">
      ...
      <form onSubmit={submit} className="mt-6 space-y-6">
        <div>
          ...
          <TextInput id="size" className="block w-full mt-1" value={data.size} disabled />
        </div>
        <div>
          <InputLabel htmlFor="crust" value="Crust" />
          <TextInput id="crust" className="block w-full mt-1" value={data.crust} disabled />
        </div>
        <div>
          <InputLabel htmlFor="toppings" value="Toppings" />
          <TextInput id="toppings" className="block w-full mt-1" value={data.toppings} disabled />
        </div>
        <div>
